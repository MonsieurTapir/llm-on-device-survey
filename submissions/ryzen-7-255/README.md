...
|---|---|---|---|---|---|
| vulkan:0 | AMD Radeon Graphics (RADV PHOENIX) | 8 | 3.64 | 64.09 | ok |
| cpu:0 | AMD Ryzen 7 255 w/ Radeon 780M Graphics | 8 | 0.41 | 48.78 | ok |

| model | quant | provider | threads | sweep | job |
|---|---|---|---|---|---|
| Ministral3-3B | q4 | cpu:0 | 8 | ok (20 pts) | ok |
| Ministral3-3B | q4 | vulkan:0 | 8 | ok (22 pts) | ok |
| Qwen3.5-4B | q4 | cpu:0 | 8 | ok (16 pts) | ok |
