...
|---|---|---|---|---|---|
| vulkan:0 | AMD Radeon 760M Graphics | 6 | 1.55 | 34.4 | ok |
| cpu:0 | AMD Ryzen 5 PRO 230 w/ Radeon 760M Graphics     | 6 | 0.51 | 31.92 | ok |

| model | quant | provider | threads | sweep | job |
|---|---|---|---|---|---|
| Ministral3-3B | q4 | cpu:0 | 6 | ok (14 pts) | ok |
| Ministral3-3B | q4 | vulkan:0 | 6 | ok (22 pts) | ok |
| Qwen3.5-4B | q4 | cpu:0 | 6 | ok (10 pts) | ok |
| Qwen3.5-4B | q4 | vulkan:0 | 6 | ok (20 pts) | ok |
| gemma4-E2B | q4 | cpu:0 | 6 | ok (20 pts) | ok |
