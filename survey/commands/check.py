"""`survey check` — conformance-check a built backend against the contract.
...
def cmd_check(args: argparse.Namespace) -> None:
    ...
    log(
        f"✓ sweep valid (gate healthy={sw.events['healthy']}; "
        f"{len(sw.events['prefill_chunks'])} prefill chunks / "
