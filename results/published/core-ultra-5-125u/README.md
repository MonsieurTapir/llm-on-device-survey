...
|---|---|---|---|---|---|
| vulkan:0 | Intel(R) Graphics (MTL) | 12 | 0.47 | 56.4 | ok |
| cpu:0 | Intel(R) Core(TM) Ultra 5 125U | 12 | 0.27 | 52.8 | ok |

| model | quant | provider | threads | sweep | job |
|---|---|---|---|---|---|
| Ministral3-3B | q4 | cpu:0 | 12 | ok (11 pts) | ok |
| Ministral3-3B | q4 | vulkan:0 | 12 | ok (18 pts) | ok |
| Qwen3.5-4B | q4 | cpu:0 | 12 | ok (9 pts) | too_slow |
| Qwen3.5-4B | q4 | vulkan:0 | 12 | ok (15 pts) | ok |
| gemma4-E2B | q4 | cpu:0 | 12 | ok (15 pts) | ok |
| gemma4-E2B | q4 | vulkan:0 | 12 | ok (11 pts) | ok |
