...
|---|---|---|---|---|---|
| mtl:0 | Apple M5 Pro | 6 | 7.2 | 138.35 | ok |
| cpu:0 | Apple M5 Pro | 6 | 1.22 | 175.92 | ok |

| model | quant | provider | threads | sweep | job |
|---|---|---|---|---|---|
| Ministral3-3B | q4 | cpu:0 | 6 | ok (17 pts) | ok |
| Ministral3-3B | q4 | mtl:0 | 6 | ok (21 pts) | ok |
| Qwen3.5-4B | q4 | cpu:0 | 6 | ok (18 pts) | ok |
| Qwen3.5-4B | q4 | mtl:0 | 6 | ok (20 pts) | ok |
| gemma4-E2B | q4 | cpu:0 | 6 | ok (21 pts) | ok |
| gemma4-E2B | q4 | mtl:0 | 6 | ok (21 pts) | ok |
